...
$HOME/isaaclab/isaaclab.sh -p zbot_direct/scripts/rsl_rl/play_keyboard.py --task=Zbot-Direct-6dof-bipedal-velocity-imu-v0 --num_envs=1 --real-time --load_run /home/yhzhu/myWorks_vips/zbot_rl_runs/zbot_rl_student/zbot_direct/2026-05-01_13-45-59/model_1499.pt
